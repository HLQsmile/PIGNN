...
def get_parser(parser=None):
    ...
    parser.add_argument('-expr','--expr',type=str,default='C:/Users/DELL/Desktop/PIGNN/data/expr1000/expr.mat.subset.csv')
    parser.add_argument('-label','--label',type=str,default='C:/Users/DELL/Desktop/PIGNN/data/expr1000/expr.label.subset.csv')
    parser.add_argument('-net','--net',type=str,default='C:/Users/DELL/Desktop/PIGNN/data/STRINGDB.graph.csv')
    parser.add_argument('-out','--outfile',type=str,default='C:/Users/DELL/Desktop/PIGNN/data/dataset.npz')
...
def coding_edge_with_ref_gene_idx(converted_graph_gene,converted_expr_gene): #输入基因调控网络和表达矩阵 构建图
    '''
...
if __name__ == '__main__':
    ...
    # normalize + log1p transform for read counts 归一化并取对数
