...
def weith(net,input_data):
    ...
    if net.weight_edge_flag:
        one_graph_edge_weight=torch.sigmoid(net.edge_weight)#*self.edge_num.  net.edge_weight为109914个
...
if __name__ == '__main__':
    ...
    for epoch in range(1, max_epoch):  #循环16
    ...
    sss = StratifiedShuffleSplit(n_splits=1, test_size=0.2, random_state=0) #分成一个数据集（train test）占比为8：2
